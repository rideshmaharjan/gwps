        ...
        <div class="edit-card">
            ...
            <div class="edit-body">
                ...
                <form method="POST" action="" id="editForm">
                    ...
                    ?>
                    <div class="form-group">
                        <label for="is_active">Package Status</label>
                ...
                <div style="margin-top: 20px; text-align: right;">
                    <a href="../public/package-details.php?id=<?php echo $id; ?>" target="_blank" style="color: #3498db; text-decoration: none; font-size: 0.9rem;">
